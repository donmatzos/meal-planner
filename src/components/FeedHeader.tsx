...
import { search } from "../recipeSlice";
            ...
            <header className="App-header h-16">
                <div className="fixed z-10 bg-zinc-900 w-full h-16 drop-shadow-md top-0 font-oswald text-violet-400 font-medium">
                    <div className="flex h-full items-center">
                        ...
                        <input className="px-4 ml-2 h-2/3 text-lg rounded-full bg-slate-800" placeholder="🔎 search for recipe..." type="text" onChange={(e) => dispatch(search(e.target.value))} />
                    </div>
                </div>
            </header>
    );
